...
void set_submit_button_callback()
{

}

void check_submit_button_hit()
{
...
void initialize_ui()
{
    ...
    char* test_choices[NUM_CHOICES_SIZE] = {"240", "216 ", "128", "64", "32", "16"};
    UI_ELEMENT* palette_size_menu =
        create_menu_ui_element(test_choices,
                               NUM_CHOICES_SIZE,
                               3,
                               23,
                               " COLOR LIMIT ");
    ...
    enum {TOTAL_ELEMENTS = 3};
    UI_ELEMENT* elements[TOTAL_ELEMENTS] = {filepath_form, palette_gen_menu, palette_size_menu};
...
void display_image(IMAGE* image, PALETTE* palette)
{
    ...
    draw_image(newwin(0,0,0,50), image);
}
